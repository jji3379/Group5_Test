package com.acorn5.project.cafe.dto;

public class CafeCommentDto {
	private int num;
	private String writer;
	private String content;
	private String target_id; //�뙎湲� ���긽�옄
	private int ref_group; //�썝湲��쓽 湲�踰덊샇
	private int comment_group; //�뙎湲� �궡�뿉�꽌�쓽 洹몃９踰덊샇
	private String deleted; //�궘�젣�맂 �뙎湲��씤吏� �뿬遺� "yes" or "no"
	private String regdate;
	private String profile; //�봽濡쒗븘 �씠誘몄� 寃쎈줈
