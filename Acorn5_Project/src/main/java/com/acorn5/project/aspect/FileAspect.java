package com.acorn5.project.aspect;
...
import com.acorn5.project.file.exception.NotAllowException;
import com.acorn5.project.file.dao.FileDao;
	...
	public void checkDelete(ProceedingJoinPoint joinPoint) 
		...
		for(Object tmp:args) {
			...
			if(tmp instanceof Integer) {
				...
				//HttpSession 을 얻어낼 HttpServletReqeust 객체 
